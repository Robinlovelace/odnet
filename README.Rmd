...
network_filenames = c("desire_lines_top.geojson", "output_max10k.geojson", "output_max10.geojson", "output_max50.geojson")
...
for(i in network_filenames[2:4]) {
  ...
  f_rnet = paste0("rnet_", i)
  sf::write_sf(routes_fast_top, f_rnet)
  piggyback::pb_upload(f_rnet)
  piggyback::pb_download_url(f_rnet)
}
```
